...
struct MUIMasterIFace
{
	...
	struct IClass * APICALL (*MUI_GetClass)(struct MUIMasterIFace *Self, const char * last);
	...
	struct MUI_CustomClass * APICALL (*MUI_CreateCustomClass)(struct MUIMasterIFace *Self, struct Library * par1, const char * par2, struct MUI_CustomClass * par3, int par4, APTR last);
