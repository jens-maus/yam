...
int SSL_add_file_cert_subjects_to_stack(STACK *stackCAs, const char *file);
int SSL_add_dir_cert_subjects_to_stack(STACK *stackCAs, const char *dir);
...
int i2d_CERTIFICATEPOLICIES(STACK *a, unsigned char **pp);
STACK *CERTIFICATEPOLICIES_new(void);
void CERTIFICATEPOLICIES_free(STACK *a);
STACK *d2i_CERTIFICATEPOLICIES(STACK **a, unsigned char **pp, long length);
...
int i2d_CRL_DIST_POINTS(STACK *a, unsigned char **pp);
STACK *CRL_DIST_POINTS_new(void);
void CRL_DIST_POINTS_free(STACK *a);
STACK *d2i_CRL_DIST_POINTS(STACK **a, unsigned char **pp, long length);
...
int X509V3_add_value_uchar(const char *name, const unsigned char *value, STACK **extlist);
...
X509 *X509_find_by_issuer_and_serial(STACK *sk, X509_NAME *name, ASN1_INTEGER *serial);
...
void X509_STORE_CTX_init(X509_STORE_CTX *ctx, X509_STORE *store, X509 *x509, STACK *chain);
