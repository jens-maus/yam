...
int __i2d_ASN1_bytes(__reg("a6") struct Library *, __reg("a0") ASN1_STRING * a, __reg("a1") unsigned char ** pp, __reg("d0") LONG d0arg, __reg("d1") LONG xclass)="\tjsr\t-1116(a6)";
#define i2d_ASN1_bytes(a, pp, d0arg, xclass) __i2d_ASN1_bytes(AmiSSLBase, (a), (pp), (d0arg), (xclass))
...
unsigned long __ASN1_tag2bit(__reg("a6") struct Library *, __reg("d0") LONG d0arg)="\tjsr\t-1128(a6)";
#define ASN1_tag2bit(d0arg) __ASN1_tag2bit(AmiSSLBase, (d0arg))
...
void __ASN1_put_object(__reg("a6") struct Library *, __reg("a0") unsigned char ** pp, __reg("d0") LONG constructed, __reg("d1") LONG length, __reg("d2") LONG d2arg, __reg("d3") LONG xclass)="\tjsr\t-1158(a6)";
#define ASN1_put_object(pp, constructed, length, d2arg, xclass) __ASN1_put_object(AmiSSLBase, (pp), (constructed), (length), (d2arg), (xclass))

int __ASN1_object_size(__reg("a6") struct Library *, __reg("d0") LONG constructed, __reg("d1") LONG length, __reg("d2") LONG d2arg)="\tjsr\t-1164(a6)";
#define ASN1_object_size(constructed, length, d2arg) __ASN1_object_size(AmiSSLBase, (constructed), (length), (d2arg))
...
const char * __ASN1_tag2str(__reg("a6") struct Library *, __reg("d0") LONG d0arg)="\tjsr\t-1254(a6)";
#define ASN1_tag2str(d0arg) __ASN1_tag2str(AmiSSLBase, (d0arg))
...
int __ASN1_item_ex_d2i(__reg("a6") struct Library *, __reg("a0") ASN1_VALUE ** pval, __reg("a1") unsigned char ** in, __reg("d0") long len, __reg("a2") const ASN1_ITEM * it, __reg("d1") LONG d1arg, __reg("d2") LONG aclass, __reg("d3") LONG opt, __reg("a3") ASN1_TLC * ctx)="\tjsr\t-1560(a6)";
#define ASN1_item_ex_d2i(pval, in, len, it, d1arg, aclass, opt, ctx) __ASN1_item_ex_d2i(AmiSSLBase, (pval), (in), (len), (it), (d1arg), (aclass), (opt), (ctx))

int __ASN1_item_ex_i2d(__reg("a6") struct Library *, __reg("a0") ASN1_VALUE ** pval, __reg("a1") unsigned char ** out, __reg("a2") const ASN1_ITEM * it, __reg("d0") LONG d0arg, __reg("d1") LONG aclass)="\tjsr\t-1566(a6)";
#define ASN1_item_ex_i2d(pval, out, it, d0arg, aclass) __ASN1_item_ex_i2d(AmiSSLBase, (pval), (out), (it), (d0arg), (aclass))
...
STACK_OF(CONF_VALUE) * __CONF_get_section(__reg("a6") struct Library *, __reg("a0") LHASH * conf, __reg("a1") const char * section)="\tjsr\t-2892(a6)";
...
STACK_OF(CONF_VALUE) * ___CONF_get_section_values(__reg("a6") struct Library *, __reg("a0") const CONF * conf, __reg("a1") const char * section)="\tjsr\t-3126(a6)";
...
//void (*)(int mode, int type, const char *file, int line) __CRYPTO_get_locking_callback(__reg("a6") struct Library *)="\tjsr\t-3270(a6)";
...
//int (*)(int *num, int mount, int type, const char *file, int line) __CRYPTO_get_add_lock_callback(__reg("a6") struct Library *)="\tjsr\t-3282(a6)";
...
//unsigned long (*)(void) __CRYPTO_get_id_callback(__reg("a6") struct Library *)="\tjsr\t-3294(a6)";
...
//struct CRYPTO_dynlock_value * (*)(const char *file, int line) __CRYPTO_get_dynlock_create_callback(__reg("a6") struct Library *)="\tjsr\t-3354(a6)";
//#define CRYPTO_get_dynlock_create_callback() __CRYPTO_get_dynlock_create_callback(AmiSSLBase)

//void (*)(int mode, struct CRYPTO_dynlock_value *l, const char *file, int line) __CRYPTO_get_dynlock_lock_callback(__reg("a6") struct Library *)="\tjsr\t-3360(a6)";
//#define CRYPTO_get_dynlock_lock_callback() __CRYPTO_get_dynlock_lock_callback(AmiSSLBase)

//void (*)(struct CRYPTO_dynlock_value *l, const char *file, int line) __CRYPTO_get_dynlock_destroy_callback(__reg("a6") struct Library *)="\tjsr\t-3366(a6)";
...
int __DSO_set_name_converter(__reg("a6") struct Library *, __reg("a0") DSO * dso, __reg("d0") DSO_NAME_CONVERTER_FUNC cb, __reg("a1") DSO_NAME_CONVERTER_FUNC * oldcb)="\tjsr\t-3600(a6)";
...
size_t __EC_POINT_point2oct(__reg("a6") struct Library *, __reg("a0") const EC_GROUP * a1, __reg("a1") const EC_POINT * a2, __reg("d0") point_conversion_form_t form, __reg("a2") unsigned char * buf, __reg("d1") ULONG len, __reg("a3") BN_CTX * a3)="\tjsr\t-3864(a6)";
...
LHASH * __lh_new(__reg("a6") struct Library *, __reg("d0") LHASH_HASH_FN_TYPE h, __reg("d1") LHASH_COMP_FN_TYPE c)="\tjsr\t-5550(a6)";
...
void __lh_doall(__reg("a6") struct Library *, __reg("a0") LHASH * lh, __reg("d0") LHASH_DOALL_FN_TYPE func)="\tjsr\t-5580(a6)";
#define lh_doall(lh, func) __lh_doall(AmiSSLBase, (lh), (func))

void __lh_doall_arg(__reg("a6") struct Library *, __reg("a0") LHASH * lh, __reg("d0") LHASH_DOALL_ARG_FN_TYPE func, __reg("a1") void * arg)="\tjsr\t-5586(a6)";
...
ASN1_STRING * __ASN1_STRING_encode(__reg("a6") struct Library *, __reg("a0") ASN1_STRING * s, __reg("a1") int (*i2d)(), __reg("a2") char * data, __reg("a3") STACK_OF(ASN1_OBJECT) * sk)="\tjsr\t-5970(a6)";
...
STACK_OF(X509_INFO) * __PEM_X509_INFO_read_bio(__reg("a6") struct Library *, __reg("a0") BIO * bp, __reg("a1") STACK_OF(X509_INFO) * sk, __reg("a2") pem_password_cb * (*cb)(char *buf, int size, int rwflag, void *userdata), __reg("a3") void * u)="\tjsr\t-6750(a6)";
...
PKCS7 * __PKCS12_pack_p7encdata(__reg("a6") struct Library *, __reg("d0") LONG pbe_nid, __reg("a0") const char * pass, __reg("d1") LONG passlen, __reg("a1") unsigned char * salt, __reg("d2") LONG saltlen, __reg("d3") LONG iter, __reg("a2") STACK_OF(PKCS12_SAFEBAG) * bags)="\tjsr\t-7134(a6)";
...
STACK_OF(PKCS12_SAFEBAG) * __PKCS12_unpack_p7encdata(__reg("a6") struct Library *, __reg("a0") PKCS7 * p7, __reg("a1") const char * pass, __reg("d0") LONG passlen)="\tjsr\t-7140(a6)";
...
STACK_OF(PKCS7) * __PKCS12_unpack_authsafes(__reg("a6") struct Library *, __reg("a0") PKCS12 * p12)="\tjsr\t-7152(a6)";
...
ASN1_TYPE * __PKCS12_get_attr_gen(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_ATTRIBUTE) * attrs, __reg("d0") LONG attr_nid)="\tjsr\t-7188(a6)";
...
PKCS12 * __PKCS12_create(__reg("a6") struct Library *, __reg("a0") char * pass, __reg("a1") char * name, __reg("a2") EVP_PKEY * pkey, __reg("a3") X509 * cert, __reg("d0") STACK_OF(X509) * ca, __reg("d1") LONG nid_key, __reg("d2") LONG nid_cert, __reg("d3") LONG iter, __reg("d4") LONG mac_iter, __reg("d5") LONG keytype)="\tjsr\t-7422(a6)";
...
PKCS7 * __PKCS7_sign(__reg("a6") struct Library *, __reg("a0") X509 * signcert, __reg("a1") EVP_PKEY * pkey, __reg("a2") STACK_OF(X509) * certs, __reg("a3") BIO * data, __reg("d0") LONG flags)="\tjsr\t-7956(a6)";
#define PKCS7_sign(signcert, pkey, certs, data, flags) __PKCS7_sign(AmiSSLBase, (signcert), (pkey), (certs), (data), (flags))

int __PKCS7_verify(__reg("a6") struct Library *, __reg("a0") PKCS7 * p7, __reg("a1") STACK_OF(X509) * certs, __reg("a2") X509_STORE * store, __reg("a3") BIO * indata, __reg("d0") BIO * out, __reg("d1") LONG flags)="\tjsr\t-7962(a6)";
#define PKCS7_verify(p7, certs, store, indata, out, flags) __PKCS7_verify(AmiSSLBase, (p7), (certs), (store), (indata), (out), (flags))

STACK_OF(X509) * __PKCS7_get0_signers(__reg("a6") struct Library *, __reg("a0") PKCS7 * p7, __reg("a1") STACK_OF(X509) * certs, __reg("d0") LONG flags)="\tjsr\t-7968(a6)";
#define PKCS7_get0_signers(p7, certs, flags) __PKCS7_get0_signers(AmiSSLBase, (p7), (certs), (flags))

PKCS7 * __PKCS7_encrypt(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509) * certs, __reg("a1") BIO * in, __reg("a2") const EVP_CIPHER * cipher, __reg("d0") LONG flags)="\tjsr\t-7974(a6)";
...
int __PKCS7_simple_smimecap(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_ALGOR) * sk, __reg("d0") LONG nid, __reg("d1") LONG arg)="\tjsr\t-7998(a6)";
...
//int (*)(int, X509_STORE_CTX *) __SSL_get_verify_callback(__reg("a6") struct Library *, __reg("a0") const SSL * s)="\tjsr\t-8418(a6)";
...
int __SSL_CTX_set_generate_session_id(__reg("a6") struct Library *, __reg("a0") SSL_CTX * a, __reg("d0") GEN_SESSION_CB b)="\tjsr\t-8646(a6)";
#define SSL_CTX_set_generate_session_id(a, b) __SSL_CTX_set_generate_session_id(AmiSSLBase, (a), (b))

int __SSL_set_generate_session_id(__reg("a6") struct Library *, __reg("a0") SSL * a, __reg("d0") GEN_SESSION_CB b)="\tjsr\t-8652(a6)";
...
//int (*)(int, X509_STORE_CTX *) __SSL_CTX_get_verify_callback(__reg("a6") struct Library *, __reg("a0") const SSL_CTX * ctx)="\tjsr\t-8694(a6)";
...
STACK_OF(X509_NAME) * __SSL_dup_CA_list(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_NAME) * sk)="\tjsr\t-9102(a6)";
...
//void (*)(const SSL *ssl, int type, int val) __SSL_get_info_callback(__reg("a6") struct Library *, __reg("a0") const SSL * ssl)="\tjsr\t-9204(a6)";
...
//int (*)(const char *const *, const char *const *) __sk_set_cmp_func(__reg("a6") struct Library *, __reg("a0") STACK * sk, __reg("a1") int (*c)(const char *const *, const char *const *))="\tjsr\t-9420(a6)";
...
int __TXT_DB_create_index(__reg("a6") struct Library *, __reg("a0") TXT_DB * db, __reg("d0") LONG field, __reg("a1") int (*qual)(), __reg("d1") LHASH_HASH_FN_TYPE hash, __reg("d2") LHASH_COMP_FN_TYPE cmp)="\tjsr\t-9486(a6)";
...
//int (*)(UI*) __UI_method_get_opener(__reg("a6") struct Library *, __reg("a0") UI_METHOD * method)="\tjsr\t-9714(a6)";
//#define UI_method_get_opener(method) __UI_method_get_opener(AmiSSLBase, (method))

//int (*)(UI*, UI_STRING*) __UI_method_get_writer(__reg("a6") struct Library *, __reg("a0") UI_METHOD * method)="\tjsr\t-9720(a6)";
//#define UI_method_get_writer(method) __UI_method_get_writer(AmiSSLBase, (method))

//int (*)(UI*) __UI_method_get_flusher(__reg("a6") struct Library *, __reg("a0") UI_METHOD * method)="\tjsr\t-9726(a6)";
//#define UI_method_get_flusher(method) __UI_method_get_flusher(AmiSSLBase, (method))

//int (*)(UI*, UI_STRING*) __UI_method_get_reader(__reg("a6") struct Library *, __reg("a0") UI_METHOD * method)="\tjsr\t-9732(a6)";
//#define UI_method_get_reader(method) __UI_method_get_reader(AmiSSLBase, (method))

//int (*)(UI*) __UI_method_get_closer(__reg("a6") struct Library *, __reg("a0") UI_METHOD * method)="\tjsr\t-9738(a6)";
...
//int (*)(int, X509 *, int) __X509_TRUST_set_default(__reg("a6") struct Library *, __reg("a0") int (*trust)(int, X509 *, int))="\tjsr\t-10722(a6)";
...
int __X509_REQ_add_extensions_nid(__reg("a6") struct Library *, __reg("a0") X509_REQ * req, __reg("a1") STACK_OF(X509_EXTENSION) * exts, __reg("d0") LONG nid)="\tjsr\t-11148(a6)";
#define X509_REQ_add_extensions_nid(req, exts, nid) __X509_REQ_add_extensions_nid(AmiSSLBase, (req), (exts), (nid))

int __X509_REQ_add_extensions(__reg("a6") struct Library *, __reg("a0") X509_REQ * req, __reg("a1") STACK_OF(X509_EXTENSION) * exts)="\tjsr\t-11154(a6)";
...
int __X509v3_get_ext_by_NID(__reg("a6") struct Library *, __reg("a0") const STACK_OF(X509_EXTENSION) * x, __reg("d0") LONG nid, __reg("d1") LONG lastpos)="\tjsr\t-11490(a6)";
#define X509v3_get_ext_by_NID(x, nid, lastpos) __X509v3_get_ext_by_NID(AmiSSLBase, (x), (nid), (lastpos))

int __X509v3_get_ext_by_OBJ(__reg("a6") struct Library *, __reg("a0") const STACK_OF(X509_EXTENSION) * x, __reg("a1") ASN1_OBJECT * obj, __reg("d0") LONG lastpos)="\tjsr\t-11496(a6)";
#define X509v3_get_ext_by_OBJ(x, obj, lastpos) __X509v3_get_ext_by_OBJ(AmiSSLBase, (x), (obj), (lastpos))

int __X509v3_get_ext_by_critical(__reg("a6") struct Library *, __reg("a0") const STACK_OF(X509_EXTENSION) * x, __reg("d0") LONG crit, __reg("d1") LONG lastpos)="\tjsr\t-11502(a6)";
#define X509v3_get_ext_by_critical(x, crit, lastpos) __X509v3_get_ext_by_critical(AmiSSLBase, (x), (crit), (lastpos))

X509_EXTENSION * __X509v3_get_ext(__reg("a6") struct Library *, __reg("a0") const STACK_OF(X509_EXTENSION) * x, __reg("d0") LONG loc)="\tjsr\t-11508(a6)";
#define X509v3_get_ext(x, loc) __X509v3_get_ext(AmiSSLBase, (x), (loc))

X509_EXTENSION * __X509v3_delete_ext(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_EXTENSION) * x, __reg("d0") LONG loc)="\tjsr\t-11514(a6)";
#define X509v3_delete_ext(x, loc) __X509v3_delete_ext(AmiSSLBase, (x), (loc))

STACK_OF(X509_EXTENSION) * __X509v3_add_ext(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_EXTENSION) ** x, __reg("a1") X509_EXTENSION * ex, __reg("d0") LONG loc)="\tjsr\t-11520(a6)";
...
int __X509at_get_attr_by_NID(__reg("a6") struct Library *, __reg("a0") const STACK_OF(X509_ATTRIBUTE) * x, __reg("d0") LONG nid, __reg("d1") LONG lastpos)="\tjsr\t-11742(a6)";
#define X509at_get_attr_by_NID(x, nid, lastpos) __X509at_get_attr_by_NID(AmiSSLBase, (x), (nid), (lastpos))

int __X509at_get_attr_by_OBJ(__reg("a6") struct Library *, __reg("a0") const STACK_OF(X509_ATTRIBUTE) * sk, __reg("a1") ASN1_OBJECT * obj, __reg("d0") LONG lastpos)="\tjsr\t-11748(a6)";
#define X509at_get_attr_by_OBJ(sk, obj, lastpos) __X509at_get_attr_by_OBJ(AmiSSLBase, (sk), (obj), (lastpos))

X509_ATTRIBUTE * __X509at_get_attr(__reg("a6") struct Library *, __reg("a0") const STACK_OF(X509_ATTRIBUTE) * x, __reg("d0") LONG loc)="\tjsr\t-11754(a6)";
#define X509at_get_attr(x, loc) __X509at_get_attr(AmiSSLBase, (x), (loc))

X509_ATTRIBUTE * __X509at_delete_attr(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_ATTRIBUTE) * x, __reg("d0") LONG loc)="\tjsr\t-11760(a6)";
...
STACK_OF(X509_ATTRIBUTE) * __X509at_add1_attr_by_OBJ(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_ATTRIBUTE) ** x, __reg("a1") const ASN1_OBJECT * obj, __reg("d0") LONG type, __reg("a2") const unsigned char * bytes, __reg("d1") LONG len)="\tjsr\t-11772(a6)";
#define X509at_add1_attr_by_OBJ(x, obj, type, bytes, len) __X509at_add1_attr_by_OBJ(AmiSSLBase, (x), (obj), (type), (bytes), (len))

STACK_OF(X509_ATTRIBUTE) * __X509at_add1_attr_by_NID(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_ATTRIBUTE) ** x, __reg("d0") LONG nid, __reg("d1") LONG type, __reg("a1") const unsigned char * bytes, __reg("d2") LONG len)="\tjsr\t-11778(a6)";
#define X509at_add1_attr_by_NID(x, nid, type, bytes, len) __X509at_add1_attr_by_NID(AmiSSLBase, (x), (nid), (type), (bytes), (len))

STACK_OF(X509_ATTRIBUTE) * __X509at_add1_attr_by_txt(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_ATTRIBUTE) ** x, __reg("a1") const char * attrname, __reg("d0") LONG type, __reg("a2") const unsigned char * bytes, __reg("d1") LONG len)="\tjsr\t-11784(a6)";
...
X509 * __X509_find_by_issuer_and_serial(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509) * sk, __reg("a1") X509_NAME * name, __reg("a2") ASN1_INTEGER * serial)="\tjsr\t-11850(a6)";
#define X509_find_by_issuer_and_serial(sk, name, serial) __X509_find_by_issuer_and_serial(AmiSSLBase, (sk), (name), (serial))

X509 * __X509_find_by_subject(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509) * sk, __reg("a1") X509_NAME * name)="\tjsr\t-11856(a6)";
...
int __X509_OBJECT_idx_by_subject(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_OBJECT) * h, __reg("d0") LONG type, __reg("a1") X509_NAME * name)="\tjsr\t-12078(a6)";
#define X509_OBJECT_idx_by_subject(h, type, name) __X509_OBJECT_idx_by_subject(AmiSSLBase, (h), (type), (name))

X509_OBJECT * __X509_OBJECT_retrieve_by_subject(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_OBJECT) * h, __reg("d0") LONG type, __reg("a1") X509_NAME * name)="\tjsr\t-12084(a6)";
...
int __X509_STORE_CTX_init(__reg("a6") struct Library *, __reg("a0") X509_STORE_CTX * ctx, __reg("a1") X509_STORE * store, __reg("a2") X509 * x509, __reg("a3") STACK_OF(X509) * chain)="\tjsr\t-12156(a6)";
#define X509_STORE_CTX_init(ctx, store, x509, chain) __X509_STORE_CTX_init(AmiSSLBase, (ctx), (store), (x509), (chain))

void __X509_STORE_CTX_trusted_stack(__reg("a6") struct Library *, __reg("a0") X509_STORE_CTX * ctx, __reg("a1") STACK_OF(X509) * sk)="\tjsr\t-12162(a6)";
...
STACK_OF(X509) * __X509_STORE_CTX_get_chain(__reg("a6") struct Library *, __reg("a0") X509_STORE_CTX * ctx)="\tjsr\t-12336(a6)";
#define X509_STORE_CTX_get_chain(ctx) __X509_STORE_CTX_get_chain(AmiSSLBase, (ctx))

STACK_OF(X509) * __X509_STORE_CTX_get1_chain(__reg("a6") struct Library *, __reg("a0") X509_STORE_CTX * ctx)="\tjsr\t-12342(a6)";
...
void __X509_STORE_CTX_set_chain(__reg("a6") struct Library *, __reg("a0") X509_STORE_CTX * c, __reg("a1") STACK_OF(X509) * sk)="\tjsr\t-12354(a6)";
...
STACK_OF(CONF_VALUE) * __i2v_GENERAL_NAME(__reg("a6") struct Library *, __reg("a0") X509V3_EXT_METHOD * method, __reg("a1") GENERAL_NAME * gen, __reg("a2") STACK_OF(CONF_VALUE) * ret)="\tjsr\t-12612(a6)";
...
STACK_OF(CONF_VALUE) * __i2v_GENERAL_NAMES(__reg("a6") struct Library *, __reg("a0") X509V3_EXT_METHOD * method, __reg("a1") GENERAL_NAMES * gen, __reg("a2") STACK_OF(CONF_VALUE) * extlist)="\tjsr\t-12654(a6)";
#define i2v_GENERAL_NAMES(method, gen, extlist) __i2v_GENERAL_NAMES(AmiSSLBase, (method), (gen), (extlist))

GENERAL_NAMES * __v2i_GENERAL_NAMES(__reg("a6") struct Library *, __reg("a0") X509V3_EXT_METHOD * method, __reg("a1") X509V3_CTX * ctx, __reg("a2") STACK_OF(CONF_VALUE) * nval)="\tjsr\t-12660(a6)";
...
int __X509V3_EXT_add_nconf_sk(__reg("a6") struct Library *, __reg("a0") CONF * conf, __reg("a1") X509V3_CTX * ctx, __reg("a2") char * section, __reg("a3") STACK_OF(X509_EXTENSION) ** sk)="\tjsr\t-13098(a6)";
...
int __X509V3_add_value_bool_nf(__reg("a6") struct Library *, __reg("a0") char * name, __reg("d0") LONG asn1_bool, __reg("a1") STACK_OF(CONF_VALUE) ** extlist)="\tjsr\t-13152(a6)";
...
STACK_OF(CONF_VALUE) * __X509V3_get_section(__reg("a6") struct Library *, __reg("a0") X509V3_CTX * ctx, __reg("a1") char * section)="\tjsr\t-13188(a6)";
...
void __X509V3_section_free(__reg("a6") struct Library *, __reg("a0") X509V3_CTX * ctx, __reg("a1") STACK_OF(CONF_VALUE) * section)="\tjsr\t-13200(a6)";
...
int __X509V3_add_value(__reg("a6") struct Library *, __reg("a0") const char * name, __reg("a1") const char * value, __reg("a2") STACK_OF(CONF_VALUE) ** extlist)="\tjsr\t-13212(a6)";
#define X509V3_add_value(name, value, extlist) __X509V3_add_value(AmiSSLBase, (name), (value), (extlist))

int __X509V3_add_value_uchar(__reg("a6") struct Library *, __reg("a0") const char * name, __reg("a1") const unsigned char * value, __reg("a2") STACK_OF(CONF_VALUE) ** extlist)="\tjsr\t-13218(a6)";
#define X509V3_add_value_uchar(name, value, extlist) __X509V3_add_value_uchar(AmiSSLBase, (name), (value), (extlist))

int __X509V3_add_value_bool(__reg("a6") struct Library *, __reg("a0") const char * name, __reg("d0") LONG asn1_bool, __reg("a1") STACK_OF(CONF_VALUE) ** extlist)="\tjsr\t-13224(a6)";
#define X509V3_add_value_bool(name, asn1_bool, extlist) __X509V3_add_value_bool(AmiSSLBase, (name), (asn1_bool), (extlist))

int __X509V3_add_value_int(__reg("a6") struct Library *, __reg("a0") const char * name, __reg("a1") ASN1_INTEGER * aint, __reg("a2") STACK_OF(CONF_VALUE) ** extlist)="\tjsr\t-13230(a6)";
...
STACK_OF(CONF_VALUE) * __X509V3_parse_list(__reg("a6") struct Library *, __reg("a0") const char * line)="\tjsr\t-13302(a6)";
...
void * __X509V3_get_d2i(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_EXTENSION) * x, __reg("d0") LONG nid, __reg("a1") int * crit, __reg("a2") int * idx)="\tjsr\t-13314(a6)";
...
int __X509V3_add1_i2d(__reg("a6") struct Library *, __reg("a0") STACK_OF(X509_EXTENSION) ** x, __reg("d0") LONG nid, __reg("a1") void * value, __reg("d1") LONG crit, __reg("d2") unsigned long flags)="\tjsr\t-13326(a6)";
...
void __X509V3_EXT_val_prn(__reg("a6") struct Library *, __reg("a0") BIO * out, __reg("a1") STACK_OF(CONF_VALUE) * val, __reg("d0") LONG indent, __reg("d1") LONG ml)="\tjsr\t-13350(a6)";
...
int __X509V3_extensions_print(__reg("a6") struct Library *, __reg("a0") BIO * out, __reg("a1") char * title, __reg("a2") STACK_OF(X509_EXTENSION) * exts, __reg("d0") unsigned long flag, __reg("d1") LONG indent)="\tjsr\t-13362(a6)";
...
int __AES_set_encrypt_key(__reg("a6") struct Library *, __reg("a0") const unsigned char * userKey, __reg("d0") const LONG bits, __reg("a1") AES_KEY * key)="\tjsr\t-13482(a6)";
#define AES_set_encrypt_key(userKey, bits, key) __AES_set_encrypt_key(AmiSSLBase, (userKey), (bits), (key))

int __AES_set_decrypt_key(__reg("a6") struct Library *, __reg("a0") const unsigned char * userKey, __reg("d0") const LONG bits, __reg("a1") AES_KEY * key)="\tjsr\t-13488(a6)";
...
void __AES_ecb_encrypt(__reg("a6") struct Library *, __reg("a0") const unsigned char * in, __reg("a1") unsigned char * out, __reg("a2") const AES_KEY * key, __reg("d0") const LONG enc)="\tjsr\t-13506(a6)";
#define AES_ecb_encrypt(in, out, key, enc) __AES_ecb_encrypt(AmiSSLBase, (in), (out), (key), (enc))

void __AES_cbc_encrypt(__reg("a6") struct Library *, __reg("a0") const unsigned char * in, __reg("a1") unsigned char * out, __reg("d0") const unsigned long length, __reg("a2") const AES_KEY * key, __reg("a3") unsigned char * ivec, __reg("d1") const LONG enc)="\tjsr\t-13512(a6)";
#define AES_cbc_encrypt(in, out, length, key, ivec, enc) __AES_cbc_encrypt(AmiSSLBase, (in), (out), (length), (key), (ivec), (enc))

void __AES_cfb128_encrypt(__reg("a6") struct Library *, __reg("a0") const unsigned char * in, __reg("a1") unsigned char * out, __reg("d0") const unsigned long length, __reg("a2") const AES_KEY * key, __reg("a3") unsigned char * ivec, __reg("d1") int * num, __reg("d2") const LONG enc)="\tjsr\t-13518(a6)";
#define AES_cfb128_encrypt(in, out, length, key, ivec, num, enc) __AES_cfb128_encrypt(AmiSSLBase, (in), (out), (length), (key), (ivec), (num), (enc))

void __AES_cfb1_encrypt(__reg("a6") struct Library *, __reg("a0") const unsigned char * in, __reg("a1") unsigned char * out, __reg("d0") const unsigned long length, __reg("a2") const AES_KEY * key, __reg("a3") unsigned char * ivec, __reg("d1") int * num, __reg("d2") const LONG enc)="\tjsr\t-13524(a6)";
#define AES_cfb1_encrypt(in, out, length, key, ivec, num, enc) __AES_cfb1_encrypt(AmiSSLBase, (in), (out), (length), (key), (ivec), (num), (enc))

void __AES_cfb8_encrypt(__reg("a6") struct Library *, __reg("a0") const unsigned char * in, __reg("a1") unsigned char * out, __reg("d0") const unsigned long length, __reg("a2") const AES_KEY * key, __reg("a3") unsigned char * ivec, __reg("d1") int * num, __reg("d2") const LONG enc)="\tjsr\t-13530(a6)";
#define AES_cfb8_encrypt(in, out, length, key, ivec, num, enc) __AES_cfb8_encrypt(AmiSSLBase, (in), (out), (length), (key), (ivec), (num), (enc))

void __AES_cfbr_encrypt_block(__reg("a6") struct Library *, __reg("a0") const unsigned char * in, __reg("a1") unsigned char * out, __reg("d0") const LONG nbits, __reg("a2") const AES_KEY * key, __reg("a3") unsigned char * ivec, __reg("d1") const LONG enc)="\tjsr\t-13536(a6)";
...
DES_LONG __DES_cbc_cksum(__reg("a6") struct Library *, __reg("a0") const unsigned char * input, __reg("a1") DES_cblock * output, __reg("d0") long length, __reg("a2") DES_key_schedule * schedule, __reg("a3") const_DES_cblock * ivec)="\tjsr\t-13668(a6)";
...
void __DES_xcbc_encrypt(__reg("a6") struct Library *, __reg("a0") const unsigned char * input, __reg("a1") unsigned char * output, __reg("d0") long length, __reg("a2") DES_key_schedule * schedule, __reg("a3") DES_cblock * ivec, __reg("d1") const_DES_cblock * inw, __reg("d2") const_DES_cblock * outw, __reg("d3") LONG enc)="\tjsr\t-13686(a6)";
...
void __DES_ecb_encrypt(__reg("a6") struct Library *, __reg("a0") const_DES_cblock * input, __reg("a1") DES_cblock * output, __reg("a2") DES_key_schedule * ks, __reg("d0") LONG enc)="\tjsr\t-13698(a6)";
...
void __DES_xwhite_in2out(__reg("a6") struct Library *, __reg("a0") const_DES_cblock * DES_key, __reg("a1") const_DES_cblock * in_white, __reg("a2") DES_cblock * out_white)="\tjsr\t-13758(a6)";
...
int __DES_check_key_parity(__reg("a6") struct Library *, __reg("a0") const_DES_cblock * key)="\tjsr\t-13818(a6)";
#define DES_check_key_parity(key) __DES_check_key_parity(AmiSSLBase, (key))

int __DES_is_weak_key(__reg("a6") struct Library *, __reg("a0") const_DES_cblock * key)="\tjsr\t-13824(a6)";
#define DES_is_weak_key(key) __DES_is_weak_key(AmiSSLBase, (key))

int __DES_set_key(__reg("a6") struct Library *, __reg("a0") const_DES_cblock * key, __reg("a1") DES_key_schedule * schedule)="\tjsr\t-13830(a6)";
#define DES_set_key(key, schedule) __DES_set_key(AmiSSLBase, (key), (schedule))

int __DES_key_sched(__reg("a6") struct Library *, __reg("a0") const_DES_cblock * key, __reg("a1") DES_key_schedule * schedule)="\tjsr\t-13836(a6)";
#define DES_key_sched(key, schedule) __DES_key_sched(AmiSSLBase, (key), (schedule))

int __DES_set_key_checked(__reg("a6") struct Library *, __reg("a0") const_DES_cblock * key, __reg("a1") DES_key_schedule * schedule)="\tjsr\t-13842(a6)";
#define DES_set_key_checked(key, schedule) __DES_set_key_checked(AmiSSLBase, (key), (schedule))

void __DES_set_key_unchecked(__reg("a6") struct Library *, __reg("a0") const_DES_cblock * key, __reg("a1") DES_key_schedule * schedule)="\tjsr\t-13848(a6)";
...
void ___ossl_old_des_ecb3_encrypt(__reg("a6") struct Library *, __reg("a0") _ossl_old_des_cblock * input, __reg("a1") _ossl_old_des_cblock * output, __reg("d0") _ossl_old_des_key_schedule ks1, __reg("d1") _ossl_old_des_key_schedule ks2, __reg("d2") _ossl_old_des_key_schedule ks3, __reg("d3") LONG enc)="\tjsr\t-13896(a6)";
...
DES_LONG ___ossl_old_des_cbc_cksum(__reg("a6") struct Library *, __reg("a0") _ossl_old_des_cblock * input, __reg("a1") _ossl_old_des_cblock * output, __reg("d0") long length, __reg("d1") _ossl_old_des_key_schedule schedule, __reg("a2") _ossl_old_des_cblock * ivec)="\tjsr\t-13902(a6)";
...
void ___ossl_old_des_cbc_encrypt(__reg("a6") struct Library *, __reg("a0") _ossl_old_des_cblock * input, __reg("a1") _ossl_old_des_cblock * output, __reg("d0") long length, __reg("d1") _ossl_old_des_key_schedule schedule, __reg("a2") _ossl_old_des_cblock * ivec, __reg("d2") LONG enc)="\tjsr\t-13908(a6)";
...
void ___ossl_old_des_ncbc_encrypt(__reg("a6") struct Library *, __reg("a0") _ossl_old_des_cblock * input, __reg("a1") _ossl_old_des_cblock * output, __reg("d0") long length, __reg("d1") _ossl_old_des_key_schedule schedule, __reg("a2") _ossl_old_des_cblock * ivec, __reg("d2") LONG enc)="\tjsr\t-13914(a6)";
...
void ___ossl_old_des_xcbc_encrypt(__reg("a6") struct Library *, __reg("a0") _ossl_old_des_cblock * input, __reg("a1") _ossl_old_des_cblock * output, __reg("d0") long length, __reg("d1") _ossl_old_des_key_schedule schedule, __reg("a2") _ossl_old_des_cblock * ivec, __reg("a3") _ossl_old_des_cblock * inw, __reg("d2") _ossl_old_des_cblock * outw, __reg("d3") LONG enc)="\tjsr\t-13920(a6)";
...
void ___ossl_old_des_cfb_encrypt(__reg("a6") struct Library *, __reg("a0") unsigned char * in, __reg("a1") unsigned char * out, __reg("d0") LONG numbits, __reg("d1") long length, __reg("d2") _ossl_old_des_key_schedule schedule, __reg("a2") _ossl_old_des_cblock * ivec, __reg("d3") LONG enc)="\tjsr\t-13926(a6)";
...
void ___ossl_old_des_ecb_encrypt(__reg("a6") struct Library *, __reg("a0") _ossl_old_des_cblock * input, __reg("a1") _ossl_old_des_cblock * output, __reg("d0") _ossl_old_des_key_schedule ks, __reg("d1") LONG enc)="\tjsr\t-13932(a6)";
#define _ossl_old_des_ecb_encrypt(input, output, ks, enc) ___ossl_old_des_ecb_encrypt(AmiSSLBase, (input), (output), (ks), (enc))

void ___ossl_old_des_encrypt(__reg("a6") struct Library *, __reg("a0") DES_LONG * data, __reg("d0") _ossl_old_des_key_schedule ks, __reg("d1") LONG enc)="\tjsr\t-13938(a6)";
#define _ossl_old_des_encrypt(data, ks, enc) ___ossl_old_des_encrypt(AmiSSLBase, (data), (ks), (enc))

void ___ossl_old_des_encrypt2(__reg("a6") struct Library *, __reg("a0") DES_LONG * data, __reg("d0") _ossl_old_des_key_schedule ks, __reg("d1") LONG enc)="\tjsr\t-13944(a6)";
#define _ossl_old_des_encrypt2(data, ks, enc) ___ossl_old_des_encrypt2(AmiSSLBase, (data), (ks), (enc))

void ___ossl_old_des_encrypt3(__reg("a6") struct Library *, __reg("a0") DES_LONG * data, __reg("d0") _ossl_old_des_key_schedule ks1, __reg("d1") _ossl_old_des_key_schedule ks2, __reg("d2") _ossl_old_des_key_schedule ks3)="\tjsr\t-13950(a6)";
#define _ossl_old_des_encrypt3(data, ks1, ks2, ks3) ___ossl_old_des_encrypt3(AmiSSLBase, (data), (ks1), (ks2), (ks3))

void ___ossl_old_des_decrypt3(__reg("a6") struct Library *, __reg("a0") DES_LONG * data, __reg("d0") _ossl_old_des_key_schedule ks1, __reg("d1") _ossl_old_des_key_schedule ks2, __reg("d2") _ossl_old_des_key_schedule ks3)="\tjsr\t-13956(a6)";
#define _ossl_old_des_decrypt3(data, ks1, ks2, ks3) ___ossl_old_des_decrypt3(AmiSSLBase, (data), (ks1), (ks2), (ks3))

void ___ossl_old_des_ede3_cbc_encrypt(__reg("a6") struct Library *, __reg("a0") _ossl_old_des_cblock * input, __reg("a1") _ossl_old_des_cblock * output, __reg("d0") long length, __reg("d1") _ossl_old_des_key_schedule ks1, __reg("d2") _ossl_old_des_key_schedule ks2, __reg("d3") _ossl_old_des_key_schedule ks3, __reg("a2") _ossl_old_des_cblock * ivec, __reg("d4") LONG enc)="\tjsr\t-13962(a6)";
...
void ___ossl_old_des_ede3_cfb64_encrypt(__reg("a6") struct Library *, __reg("a0") unsigned char * in, __reg("a1") unsigned char * out, __reg("d0") long length, __reg("d1") _ossl_old_des_key_schedule ks1, __reg("d2") _ossl_old_des_key_schedule ks2, __reg("d3") _ossl_old_des_key_schedule ks3, __reg("a2") _ossl_old_des_cblock * ivec, __reg("a3") int * num, __reg("d4") LONG enc)="\tjsr\t-13968(a6)";
...
void ___ossl_old_des_ede3_ofb64_encrypt(__reg("a6") struct Library *, __reg("a0") unsigned char * in, __reg("a1") unsigned char * out, __reg("d0") long length, __reg("d1") _ossl_old_des_key_schedule ks1, __reg("d2") _ossl_old_des_key_schedule ks2, __reg("d3") _ossl_old_des_key_schedule ks3, __reg("a2") _ossl_old_des_cblock * ivec, __reg("a3") int * num)="\tjsr\t-13974(a6)";
...
int ___ossl_old_des_enc_read(__reg("a6") struct Library *, __reg("d0") LONG fd, __reg("a0") char * buf, __reg("d1") LONG len, __reg("d2") _ossl_old_des_key_schedule sched, __reg("a1") _ossl_old_des_cblock * iv)="\tjsr\t-13986(a6)";
#define _ossl_old_des_enc_read(fd, buf, len, sched, iv) ___ossl_old_des_enc_read(AmiSSLBase, (fd), (buf), (len), (sched), (iv))

int ___ossl_old_des_enc_write(__reg("a6") struct Library *, __reg("d0") LONG fd, __reg("a0") char * buf, __reg("d1") LONG len, __reg("d2") _ossl_old_des_key_schedule sched, __reg("a1") _ossl_old_des_cblock * iv)="\tjsr\t-13992(a6)";
...
void ___ossl_old_des_ofb_encrypt(__reg("a6") struct Library *, __reg("a0") unsigned char * in, __reg("a1") unsigned char * out, __reg("d0") LONG numbits, __reg("d1") long length, __reg("d2") _ossl_old_des_key_schedule schedule, __reg("a2") _ossl_old_des_cblock * ivec)="\tjsr\t-14016(a6)";
...
void ___ossl_old_des_pcbc_encrypt(__reg("a6") struct Library *, __reg("a0") _ossl_old_des_cblock * input, __reg("a1") _ossl_old_des_cblock * output, __reg("d0") long length, __reg("d1") _ossl_old_des_key_schedule schedule, __reg("a2") _ossl_old_des_cblock * ivec, __reg("d2") LONG enc)="\tjsr\t-14022(a6)";
...
void ___ossl_old_des_random_seed(__reg("a6") struct Library *, __reg("d0") _ossl_old_des_cblock key)="\tjsr\t-14034(a6)";
#define _ossl_old_des_random_seed(key) ___ossl_old_des_random_seed(AmiSSLBase, (key))

void ___ossl_old_des_random_key(__reg("a6") struct Library *, __reg("d0") _ossl_old_des_cblock ret)="\tjsr\t-14040(a6)";
...
int ___ossl_old_des_set_key(__reg("a6") struct Library *, __reg("a0") _ossl_old_des_cblock * key, __reg("d0") _ossl_old_des_key_schedule schedule)="\tjsr\t-14070(a6)";
#define _ossl_old_des_set_key(key, schedule) ___ossl_old_des_set_key(AmiSSLBase, (key), (schedule))

int ___ossl_old_des_key_sched(__reg("a6") struct Library *, __reg("a0") _ossl_old_des_cblock * key, __reg("d0") _ossl_old_des_key_schedule schedule)="\tjsr\t-14076(a6)";
...
void ___ossl_old_des_cfb64_encrypt(__reg("a6") struct Library *, __reg("a0") unsigned char * in, __reg("a1") unsigned char * out, __reg("d0") long length, __reg("d1") _ossl_old_des_key_schedule schedule, __reg("a2") _ossl_old_des_cblock * ivec, __reg("a3") int * num, __reg("d2") LONG enc)="\tjsr\t-14094(a6)";
...
void ___ossl_old_des_ofb64_encrypt(__reg("a6") struct Library *, __reg("a0") unsigned char * in, __reg("a1") unsigned char * out, __reg("d0") long length, __reg("d1") _ossl_old_des_key_schedule schedule, __reg("a2") _ossl_old_des_cblock * ivec, __reg("a3") int * num)="\tjsr\t-14100(a6)";
