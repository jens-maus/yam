/*
 * $Id: bsdsocket.h,v 1.15 2006/03/31 10:05:21 obarthel Exp $
 *
 * :ts=8
 *
...
#define RemoveInterface(interface_name, force) ({ \
  ...
  ({ \
  register struct Library * const __RemoveInterface__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
