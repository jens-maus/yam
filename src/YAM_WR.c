...
static struct WR_ClassData *WR_New(int winnum)
{
  ...
  if((data = calloc(1, sizeof(struct WR_ClassData))) != NULL)
  {
          ...
          Child, data->GUI.RG_PAGE = RegisterGroup(rtitles),
             ...
             Child, VGroup, /* Message */
                ...
                Child, ColGroup(2),
                   ...
                   Child, MakeAddressField(&data->GUI.ST_TO, tr(MSG_WR_To), MSG_HELP_WR_ST_TO, ABM_TO, winnum, AFF_ALLOW_MULTI|AFF_EXTERNAL_SHORTCUTS),
             ...
             Child, VGroup, /* Options */
                ...
                Child, ColGroup(2),
                   ...
                   Child, MakeAddressField(&data->GUI.ST_CC, tr(MSG_WR_CopyTo), MSG_HELP_WR_ST_CC, ABM_CC, winnum, AFF_ALLOW_MULTI|AFF_EXTERNAL_SHORTCUTS),

                   Child, Label(tr(MSG_WR_BlindCopyTo)),
                   Child, MakeAddressField(&data->GUI.ST_BCC, tr(MSG_WR_BlindCopyTo), MSG_HELP_WR_ST_BCC, ABM_BCC, winnum, AFF_ALLOW_MULTI|AFF_EXTERNAL_SHORTCUTS),

                   Child, Label(tr(MSG_WR_From)),
                   Child, MakeAddressField(&data->GUI.ST_FROM, tr(MSG_WR_From), MSG_HELP_WR_ST_FROM, ABM_FROM, winnum, AFF_ALLOW_MULTI|AFF_EXTERNAL_SHORTCUTS),

                   Child, Label(tr(MSG_WR_ReplyTo)),
                   Child, MakeAddressField(&data->GUI.ST_REPLYTO, tr(MSG_WR_ReplyTo), MSG_HELP_WR_ST_REPLYTO, ABM_REPLYTO, winnum, AFF_ALLOW_MULTI|AFF_EXTERNAL_SHORTCUTS),
    ...
    if(data->GUI.WI != NULL && slider != NULL)
    {
      ...
      DoMethod(data->GUI.LV_ATTACH  ,MUIM_Notify,MUIA_NList_DoubleClick   ,MUIV_EveryTime,MUIV_Notify_Application,3,MUIM_CallHook   ,&WR_DisplayFileHook,winnum);
