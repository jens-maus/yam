              ...
              Child, RegisterGroup(rtitles),
                 ...
                 Child, VGroup,
                    Child, ColGroup(3),
                       ...
                       Child, MakeAddressField(&data->GUI.ST_ABOUNCE, tr(MSG_CO_ActionBounce), MSG_HELP_CO_ST_ABOUNCE, ABM_CONFIG, -1, AFF_ALLOW_MULTI),
                       Child, data->GUI.CH_AFORWARD = MakeCheck(tr(MSG_CO_ActionForward)),
                       Child, LLabel2(tr(MSG_CO_ActionForward)),
                       Child, MakeAddressField(&data->GUI.ST_AFORWARD, tr(MSG_CO_ActionForward), MSG_HELP_CO_ST_AFORWARD, ABM_CONFIG, -1, AFF_ALLOW_MULTI),
