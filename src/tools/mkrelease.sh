...
cp -a ../locale/YAM.pot "release/$yamsys/YAM $yamver/Catalogs/"
...
cp -a ../doc/isyamrunning.rx "release/$yamsys/YAM $yamver/Install/"
cp -a ../doc/quityam.rx "release/$yamsys/YAM $yamver/Install/"
