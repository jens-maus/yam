...
mkdir -p "release/$yamsys/YAM $yamver/Catalogs/czech"
cp ../locale/czech.catalog "release/$yamsys/YAM $yamver/Catalogs/czech/YAM.catalog"
mkdir -p "release/$yamsys/YAM $yamver/Catalogs/dutch"
cp ../locale/dutch.catalog "release/$yamsys/YAM $yamver/Catalogs/dutch/YAM.catalog"
mkdir -p "release/$yamsys/YAM $yamver/Catalogs/english-british"
cp ../locale/english-british.catalog "release/$yamsys/YAM $yamver/Catalogs/english-british/YAM.catalog"
mkdir -p "release/$yamsys/YAM $yamver/Catalogs/french"
cp ../locale/french.catalog "release/$yamsys/YAM $yamver/Catalogs/french/YAM.catalog"
mkdir -p "release/$yamsys/YAM $yamver/Catalogs/german"
cp ../locale/german.catalog "release/$yamsys/YAM $yamver/Catalogs/german/YAM.catalog"
mkdir -p "release/$yamsys/YAM $yamver/Catalogs/greek"
cp ../locale/greek.catalog "release/$yamsys/YAM $yamver/Catalogs/greek/YAM.catalog"
mkdir -p "release/$yamsys/YAM $yamver/Catalogs/italian"
cp ../locale/italian.catalog "release/$yamsys/YAM $yamver/Catalogs/italian/YAM.catalog"
mkdir -p "release/$yamsys/YAM $yamver/Catalogs/polish"
cp ../locale/dutch.catalog "release/$yamsys/YAM $yamver/Catalogs/polish/YAM.catalog"
mkdir -p "release/$yamsys/YAM $yamver/Catalogs/swedish"
cp ../locale/swedish.catalog "release/$yamsys/YAM $yamver/Catalogs/swedish/YAM.catalog"
echo "  MK $yamsys/Docs"
