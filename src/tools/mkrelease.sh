...
for language in czech english-british french german hungarian italian spanish swedish turkish; do
	mkdir -p "release/$yamsys/YAM $yamver/Catalogs/$language"
	cp -a ../locale/$language.catalog "release/$yamsys/YAM $yamver/Catalogs/$language/YAM.catalog"
done
echo "  MK $yamsys/Docs"
...
cp -a ../icons/$yamicons/Gallery_directory.info "release/$yamsys/YAM $yamver/Gallery.info"
cp -a ../doc/ReadMe_gallery "release/$yamsys/YAM $yamver/Gallery/ReadMe"
cp -a ../icons/$yamicons/ReadMe.info "release/$yamsys/YAM $yamver/Gallery/ReadMe.info"
...
cp -ra ../resources/* "release/$yamsys/YAM $yamver/Resources/"
cp -a ../icons/$yamicons/Themes_directory.info "release/$yamsys/YAM $yamver/Resources.info"
