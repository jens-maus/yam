...
static void InitBeforeLogin(BOOL hidden)
{
  ...
  CheckMCC(MUIC_NList,      20, 125, TRUE, "http://www.sf.net/projects/nlist-classes/");
  CheckMCC(MUIC_NListview,  19,  80, TRUE, "http://www.sf.net/projects/nlist-classes/");
  CheckMCC(MUIC_NFloattext, 19,  61, TRUE, "http://www.sf.net/projects/nlist-classes/");
  CheckMCC(MUIC_NListtree,  18,  32, TRUE, "http://www.sf.net/projects/nlist-classes/");
  CheckMCC(MUIC_NBalance,   15,   6, TRUE, "http://www.sf.net/projects/nlist-classes/");
