...
static void InitBeforeLogin(BOOL hidden)
{
  ...
  // local charset.
  INITLIB("codesets.library", 6, 21, &CodesetsBase,  "main", 1, &ICodesets,  TRUE, "https://github.com/jens-maus/libcodesets");
  ...
  CheckMCC(MUIC_BetterString, 11,  36,  30,   0, TRUE, "https://github.com/amiga-mui/betterstring");
  ...
  CheckMCC(MUIC_TextEditor,   15,  56,   0,   0, TRUE, "https://github.com/amiga-mui/texteditor");
...
int main(int argc, char **argv)
{
  ...
  // initialize all strings to their built-in default strings to make the tr() macro
  // usable even without having the catalog opened yet.
  InitYAMCatalog();
