#ifndef RECEIVEMAILS_H
#define RECEIVEMAILS_H
...
enum ReceiveMode
{
  RECV_USER = 0,   // receive mails on manual user request
  RECV_AUTO_START, // receive mails on autorequest (start of app)
  RECV_AUTO_TIMER, // receive mails on autorequest (timer)
  RECV_AUTO_REXX,  // receive mails on autorequest (rexx)
};
