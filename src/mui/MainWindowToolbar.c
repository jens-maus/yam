...
OVERLOAD(OM_NEW)
{
                       ...
                       TAG_MORE, inittags(msg))))
  {
    ...
    DoMethod(obj, MUIM_TheBar_Notify, TB_MAIN_GETMAIL, MUIA_Pressed, FALSE, MUIV_Notify_Application, 8, MUIM_Application_PushMethod, G->App, 5, MUIM_CallHook, &MA_PopNowHook, RECV_USER, -1, MUIV_TheBar_Qualifier);
