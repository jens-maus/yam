    ...
    data->GUI.WI = WindowObject,
       ...
       WindowContents, VGroup,
          ...
          Child, ColGroup(2), GroupFrameT(tr(MSG_FO_MLSupport)),
             ...
             Child, MakeAddressField(&data->GUI.ST_MLADDRESS, tr(MSG_FO_TO_ADDRESS), MSG_HELP_FO_ST_MLADDRESS, ABM_CONFIG, -1, TRUE),
             Child, Label2(tr(MSG_FO_FROM_ADDRESS)),
             Child, MakeAddressField(&data->GUI.ST_MLFROMADDRESS, tr(MSG_FO_FROM_ADDRESS), MSG_HELP_FO_ST_MLFROMADDRESS, ABM_CONFIG, -1, TRUE),
             Child, Label2(tr(MSG_FO_REPLYTO_ADDRESS)),
             Child, MakeAddressField(&data->GUI.ST_MLREPLYTOADDRESS, tr(MSG_FO_REPLYTO_ADDRESS), MSG_HELP_FO_ST_MLREPLYTOADDRESS, ABM_CONFIG, -1, TRUE),
