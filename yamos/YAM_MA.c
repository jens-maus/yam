...
SAVEDS ASM void MA_DelKeyFunc(REG(a1) int *arg)
{
   ...
   if (obj == G->MA->GUI.LV_FOLDERS) FO_DeleteFolderFunc();
   ...
   if (data = calloc(1,sizeof(struct MA_ClassData)))
   {
      ...
      data->GUI.MS_MAIN = MenustripObject,
         MUIA_Family_Child, MenuObject, MUIA_Menu_Title, GetStr(MSG_MA_Project),
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_About), MUIA_Menuitem_Shortcut,"?", MUIA_UserData,MMEN_ABOUT, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_AboutMUI), MUIA_UserData,MMEN_ABOUTMUI, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_CheckVersion), MUIA_UserData,MMEN_VERSION, End,
            MUIA_Family_Child, data->GUI.MI_ERRORS = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_LastErrors), MUIA_Menuitem_Enabled,FALSE, MUIA_UserData,MMEN_ERRORS, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,NM_BARLABEL, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_Restart), MUIA_UserData,MMEN_LOGIN, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_Hide), MUIA_Menuitem_Shortcut,"H", MUIA_UserData,MMEN_HIDE, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_Quit), MUIA_Menuitem_Shortcut,"Q", MUIA_UserData,MMEN_QUIT, End,
         End,
         MUIA_Family_Child, data->GUI.MN_FOLDER = MenuObject, MUIA_Menu_Title, GetStr(MSG_Folder),
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_NewFolder), MUIA_UserData,MMEN_NEWF, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_NewSeparator), MUIA_UserData,MMEN_NEWS, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MEdit), MUIA_UserData,MMEN_EDITF, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MDelete), MUIA_UserData,MMEN_DELETEF, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_SortOrder),
               MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_OSave), MUIA_UserData,MMEN_OSAVE, End,
               MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_Reset), MUIA_UserData,MMEN_ORESET, End,
            End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,NM_BARLABEL, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MSearch), MUIA_Menuitem_Shortcut,"F", MUIA_UserData,MMEN_SEARCH, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MFilter), MUIA_Menuitem_Shortcut,"I", MUIA_UserData,MMEN_FILTER, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,NM_BARLABEL, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_RemoveDeleted), MUIA_Menuitem_Shortcut,"Z", MUIA_UserData,MMEN_DELDEL, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_UpdateIndex), MUIA_Menuitem_Shortcut,"U", MUIA_UserData,MMEN_INDEX, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_FlushIndices), MUIA_UserData,MMEN_FLUSH, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,NM_BARLABEL, End,
            MUIA_Family_Child, data->GUI.MI_IMPORT = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_ImportMessages), MUIA_UserData,MMEN_IMPORT, End,
            MUIA_Family_Child, data->GUI.MI_EXPORT = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_ExportMessages), MUIA_UserData,MMEN_EXPORT, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,NM_BARLABEL, End,
            MUIA_Family_Child, data->GUI.MI_SENDALL = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MSendAll), MUIA_Menuitem_Shortcut,"S", MUIA_UserData,MMEN_SENDMAIL, End,
            MUIA_Family_Child, data->GUI.MI_EXCHANGE = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_Exchange), MUIA_Menuitem_Shortcut,"X", MUIA_UserData,MMEN_EXMAIL, End,
            MUIA_Family_Child, data->GUI.MI_GETMAIL = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MGetMail), MUIA_Menuitem_Shortcut,"G", MUIA_UserData,MMEN_GETMAIL, End,
        End,
         MUIA_Family_Child, MenuObject, MUIA_Menu_Title, GetStr(MSG_Message),
            MUIA_Family_Child, data->GUI.MI_READ = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MRead), MUIA_Menuitem_Shortcut,"D", MUIA_UserData,MMEN_READ, End,
            MUIA_Family_Child, data->GUI.MI_EDIT = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MEdit), MUIA_Menuitem_Shortcut,"E", MUIA_UserData,MMEN_EDIT, End,
            MUIA_Family_Child, data->GUI.MI_MOVE = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MMove), MUIA_Menuitem_Shortcut,"M", MUIA_UserData,MMEN_MOVE, End,
            MUIA_Family_Child, data->GUI.MI_COPY = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MCopy), MUIA_Menuitem_Shortcut,"Y", MUIA_UserData,MMEN_COPY, End,
            ...
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,NM_BARLABEL, End,
            MUIA_Family_Child, data->GUI.MI_PRINT = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_Print), MUIA_Menuitem_Shortcut,"P", MUIA_UserData,MMEN_PRINT, End,
            MUIA_Family_Child, data->GUI.MI_SAVE = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_Save), MUIA_Menuitem_Shortcut,"V", MUIA_UserData,MMEN_SAVE, End,
            MUIA_Family_Child, data->GUI.MI_ATTACH = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_Attachments),
               MUIA_Family_Child, data->GUI.MI_SAVEATT = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_Save), MUIA_Menuitem_Shortcut,"T", MUIA_UserData,MMEN_DETACH, End,
               MUIA_Family_Child, data->GUI.MI_REMATT = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_Crop), MUIA_Menuitem_Shortcut,"O", MUIA_UserData,MMEN_CROP, End,
            End,
            MUIA_Family_Child, data->GUI.MI_EXPMSG = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_ExportMessages), MUIA_UserData,MMEN_EXPMSG, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,NM_BARLABEL, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_New), MUIA_Menuitem_Shortcut,"N", MUIA_UserData,MMEN_NEW, End,
            MUIA_Family_Child, data->GUI.MI_REPLY = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MReply), MUIA_Menuitem_Shortcut,"R", MUIA_UserData,MMEN_REPLY, End,
            MUIA_Family_Child, data->GUI.MI_FORWARD = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MForward), MUIA_Menuitem_Shortcut,"W", MUIA_UserData,MMEN_FORWARD, End,
            MUIA_Family_Child, data->GUI.MI_BOUNCE = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MBounce), MUIA_Menuitem_Shortcut,"B", MUIA_UserData,MMEN_BOUNCE, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,NM_BARLABEL, End,
            MUIA_Family_Child, data->GUI.MI_GETADDRESS = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MGetAddress), MUIA_Menuitem_Shortcut,"J", MUIA_UserData,MMEN_SAVEADDR, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_Select),
               MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_SelectAll), MUIA_Menuitem_Shortcut,"L", MUIA_UserData,MMEN_SELALL, End,
               MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_SelectNone), MUIA_UserData,MMEN_SELNONE, End,
               MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_SelectToggle), MUIA_UserData,MMEN_SELTOGG, End,
            End,
            MUIA_Family_Child, data->GUI.MI_STATUS = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_SetStatus),
               MUIA_Family_Child, data->GUI.MI_TOUNREAD = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_ToUnread), MUIA_Menuitem_Shortcut,"[", MUIA_UserData,MMEN_TOUNREAD, End,
               MUIA_Family_Child, data->GUI.MI_TOREAD = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_ToRead), MUIA_Menuitem_Shortcut,"]", MUIA_UserData,MMEN_TOREAD, End,
               MUIA_Family_Child, data->GUI.MI_TOHOLD = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_ToHold), MUIA_Menuitem_Shortcut,"{", MUIA_UserData,MMEN_TOHOLD, End,
               MUIA_Family_Child, data->GUI.MI_TOQUEUED = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_ToQueued), MUIA_Menuitem_Shortcut,"}", MUIA_UserData,MMEN_TOQUEUED, End,
            End,
            MUIA_Family_Child, data->GUI.MI_CHSUBJ = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_ChangeSubj), MUIA_UserData,MMEN_CHSUBJ, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,NM_BARLABEL, End,
            MUIA_Family_Child, data->GUI.MI_SEND = MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MSend), MUIA_UserData,MMEN_SEND, End,
         End,
         MUIA_Family_Child, MenuObject, MUIA_Menu_Title, GetStr(MSG_MA_Settings),
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MAddrBook),MUIA_Menuitem_Shortcut,"A",  MUIA_UserData,MMEN_ABOOK, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MConfig), MUIA_Menuitem_Shortcut,"K", MUIA_UserData,MMEN_CONFIG, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,GetStr(MSG_MA_MUsers), MUIA_UserData,MMEN_USER, End,
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title,"MUI...", MUIA_UserData,MMEN_MUI, End,
         End,
      End,
...
//                     MUIA_ContextMenu               , NULL,
               ...
               Child, data->GUI.LV_MAILS = NListviewObject,
                  MUIA_HelpNode, "MA01",
                  MUIA_CycleChain,1,
                  MUIA_NListview_NList, data->GUI.NL_MAILS = NListObject,
                     MUIA_NList_MinColSortable, 0,
                     MUIA_NList_TitleClick    , TRUE,
