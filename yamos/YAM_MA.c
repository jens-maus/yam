   ...
   if (data = calloc(1,sizeof(struct MA_ClassData)))
   {
      ...
      data->GUI.MS_MAIN = MenustripObject,
         MUIA_Family_Child, MenuObject, MUIA_Menu_Title, GetStr(MSG_MA_Project),
            ...
            MUIA_Family_Child, MakeMenuitem(GetStr(MSG_MA_CheckVersion), MMEN_VERSION),
         ...
         MUIA_Family_Child, data->GUI.MN_FOLDER = MenuObject, MUIA_Menu_Title, GetStr(MSG_Folder),
            MUIA_Family_Child, MakeMenuitem(GetStr(MSG_MA_NewFolder), MMEN_NEWF),
            MUIA_Family_Child, MakeMenuitem(GetStr(MSG_MA_NewSeparator), MMEN_NEWS),
            MUIA_Family_Child, MakeMenuitem(GetStr(MSG_MA_MEdit), MMEN_EDITF),
            MUIA_Family_Child, MakeMenuitem(GetStr(MSG_MA_MDelete), MMEN_DELETEF),
            ...
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title, NM_BARLABEL, End,
            MUIA_Family_Child, data->GUI.MI_IMPORT = MakeMenuitem(GetStr(MSG_MA_ImportMessages), MMEN_IMPORT),
            MUIA_Family_Child, data->GUI.MI_EXPORT = MakeMenuitem(GetStr(MSG_MA_ExportMessages), MMEN_EXPORT),
            MUIA_Family_Child, MenuitemObject, MUIA_Menuitem_Title, NM_BARLABEL, End,
        ...
        End,
         MUIA_Family_Child, MenuObject, MUIA_Menu_Title, GetStr(MSG_Message),
            ...
            MUIA_Family_Child, data->GUI.MI_COPY = MakeMenuitem(GetStr(MSG_MA_MCopy), MMEN_COPY),
         ...
         MUIA_Family_Child, MenuObject, MUIA_Menu_Title, GetStr(MSG_MA_Settings),
            ...
            MUIA_Family_Child, MakeMenuitem(GetStr(MSG_MA_MUsers), MMEN_USER),
