...
/*
** This file was machine generated by idltool 50.12.
** Do not edit
*/ 
...
struct SocketIFace
{
	...
	LONG APICALL (*bind)(struct SocketIFace *Self, LONG sock, struct sockaddr * name, LONG namelen);
	LONG APICALL (*listen)(struct SocketIFace *Self, LONG sock, LONG backlog);
	LONG APICALL (*accept)(struct SocketIFace *Self, LONG sock, struct sockaddr * addr, LONG * addrlen);
	LONG APICALL (*connect)(struct SocketIFace *Self, LONG sock, struct sockaddr * name, LONG namelen);
	LONG APICALL (*sendto)(struct SocketIFace *Self, LONG sock, APTR buf, LONG len, LONG flags, struct sockaddr * to, LONG tolen);
	LONG APICALL (*send)(struct SocketIFace *Self, LONG sock, APTR buf, LONG len, LONG flags);
	LONG APICALL (*recvfrom)(struct SocketIFace *Self, LONG sock, APTR buf, LONG len, LONG flags, struct sockaddr * addr, LONG * addrlen);
	...
	LONG APICALL (*setsockopt)(struct SocketIFace *Self, LONG sock, LONG level, LONG optname, APTR optval, LONG optlen);
	LONG APICALL (*getsockopt)(struct SocketIFace *Self, LONG sock, LONG level, LONG optname, APTR optval, LONG * optlen);
	LONG APICALL (*getsockname)(struct SocketIFace *Self, LONG sock, struct sockaddr * name, LONG * namelen);
	LONG APICALL (*getpeername)(struct SocketIFace *Self, LONG sock, struct sockaddr * name, LONG * namelen);
	...
	STRPTR APICALL (*Inet_NtoA)(struct SocketIFace *Self, ULONG ip);
	ULONG APICALL (*inet_addr)(struct SocketIFace *Self, STRPTR cp);
	ULONG APICALL (*Inet_LnaOf)(struct SocketIFace *Self, ULONG in);
	ULONG APICALL (*Inet_NetOf)(struct SocketIFace *Self, ULONG in);
	ULONG APICALL (*Inet_MakeAddr)(struct SocketIFace *Self, ULONG net, ULONG host);
	ULONG APICALL (*inet_network)(struct SocketIFace *Self, STRPTR cp);
	...
	struct netent * APICALL (*getnetbyaddr)(struct SocketIFace *Self, ULONG net, LONG type);
	...
	ULONG APICALL (*gethostid)(struct SocketIFace *Self);
	...
	LONG APICALL (*In_LocalAddr)(struct SocketIFace *Self, ULONG address);
	LONG APICALL (*In_CanForward)(struct SocketIFace *Self, ULONG address);
