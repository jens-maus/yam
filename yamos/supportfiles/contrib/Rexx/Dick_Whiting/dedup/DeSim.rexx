...
/*                                                                            */
/*----------------------------------------------------------------------------*/
/*       Find and Delete Similar Mail in a YAM 2.x folder                     */
/*----------------------------------------------------------------------------*/
/*                                                                            */
...
$AUTHOR: Dick Whiting
$DESCRIPTION: Find and Delete Similar Mail in a YAM 2.x folder
*/
...
GetMinfo:       
   ...
   do i=0 to mailcnt-1
      ...
      mdate=missing
      Call GetDate
      mstring=mfrom'|'mdate'|'msubj'|'anum'|'right(mnum,4,'0')'|'mpath
      minfo.j=mstring
   end
